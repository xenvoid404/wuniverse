                ...
                <div className="text-center space-y-12">
                    ...
                    <div className="space-y-8 animate-fade-in-up animation-delay-150">
                        ...
                        <p className="max-w-3xl mx-auto text-lg sm:text-xl lg:text-2xl text-muted-foreground leading-relaxed font-light">
                            Your ultimate toolkit with all the essential
                            utilities for development, security and productivity
                            in one place.
                            <span className="text-foreground font-medium block mt-2 sm:inline sm:mt-0">
                                {' '}
