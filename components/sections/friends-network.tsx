            ...
            <div className="max-w-6xl mx-auto">
                ...
                >
                    ...
                    <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                        Teman-teman yang telah berbagi momen indah bersama dalam
                        perjalanan gaming kita
                    </p>
                </motion.div>
                        ...
                        >
                            <div className="relative p-6">
                                ...
                                <div className="relative mx-auto w-24 h-24 mb-4">
                                    ...
                                    {/* Status Indicator */}
                                    <div
                                        className={`absolute bottom-2 right-2 w-4 h-4 rounded-full border-2 border-background ${getStatusColor(
                                            friend.status
                                        )}`}
                                    />
                                </div>
                                ...
                                <div className="overflow-y-auto max-h-[90vh]">
                                    ...
                                    <div className="relative p-8 text-center bg-gradient-to-br from-cyan-500/10 to-magenta-500/10">
                                        <div className="relative mx-auto w-32 h-32 mb-6">
                                            ...
                                            />
                                            <div
                                                className={`absolute bottom-4 right-4 w-6 h-6 rounded-full border-4 border-background ${getStatusColor(
                                    ...
                                    <div className="p-8">
                                        ...
                                        <div className="mb-8">
                                            ...
                                            <div className="flex flex-wrap gap-2">
                                                {selectedFriend.favoriteGames.map(
                                                    (game, index) => (
                                                        <span
                                                            key={index}
                                        ...
                                        <div className="mb-8">
                                            ...
                                            <div className="space-y-2">
                                                {selectedFriend.memories.map(
                                                    (memory, index) => (
                                                        <div
                                                            key={index}
                                                            className="p-3 cyberpunk-card rounded-lg"
                                                        >
                                                            <p className="text-sm">
                                                                {memory}
                                                            </p>
                                        ...
                                        <div className="mb-8">
                                            ...
                                            <div className="flex flex-wrap gap-2">
                                                {selectedFriend.achievements.map(
                                                    (achievement, index) => (
                                                        <span
                                                            key={index}
                                        ...
                                        <div className="mb-8">
                                            ...
                                            <div className="flex flex-wrap gap-2">
                                                {selectedFriend.personalityTraits.map(
                                                    (trait, index) => (
                                                        <span
                                                            key={index}
                                        ...
                                        <div>
                                            ...
                                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                                {selectedFriend.socialLinks.map(
                                                    (social, index) => (
                                                        <a
                                                            key={index}
                                                            href={social.url}
