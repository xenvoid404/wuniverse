...
export function AppHeader({ sidebarOpen }: AppHeaderProps) {
    return (
        <header className="sticky top-0 z-50 w-full glass-effect border-b border-foreground/20">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-16">
                    <Link href="/" aria-label="Wuniverse - Go To Homepage">
                        <h1 className="text-2xl font-monsterrat font-black text-primary">Wuniverse</h1>
                    </Link>
                    ...
                    <nav className="hidden md:flex items-center space-x-8">
                        ...
                        <Link href="#albums" className="text-foreground hover:text-primary transition-colors">
                            Albums
                        </Link>
